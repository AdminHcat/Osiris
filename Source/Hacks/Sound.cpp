...
void Sound::drawGUI(bool contentOnly) noexcept
{
    if (!contentOnly) {
        ...
        ImGui::Begin("音效", &soundWindowOpen, ImGuiWindowFlags_NoCollapse | ImGuiWindowFlags_NoResize | ImGuiWindowFlags_NoScrollbar | ImGuiWindowFlags_NoScrollWithMouse);
    }

    ImGui::PushID("Sound");
    ImGui::SliderInt("小鸡音量", &chickenVolume, 0, 200, "%d%%");
    ...
    ImGui::SliderInt("脚步声音量", &players[currentCategory].footstepVolume, 0, 200, "%d%%");
    ImGui::PopID();

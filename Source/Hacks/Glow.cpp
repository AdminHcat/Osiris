...
void Glow::drawGUI(bool contentOnly) noexcept
{
    ...
    ImGui::PushID(0);
    constexpr std::array categories{ "盟友", "敌人", "Planting", "Defusing", "本地玩家", "武器", "C4", "已放置的 C4", "小鸡", "Defuse Kits", "投射物", "人质", "Ragdolls" };
    ...
    if (currentCategory <= 3) {
        ...
        ImGui::PushID(1);
        ImGui::Combo("", &currentType, "全部\0Visible\0Occluded\0");
        ImGui::PopID();
    ...
    ImGui::Checkbox("基于生命值", &currentItem->healthBased);

    ImGuiCustom::colorPicker("颜色", *currentItem);

    ImGui::NextColumn();
    ImGui::SetNextItemWidth(100.0f);
    ImGui::Combo("样式", &currentItem->style, "默认\0Rim3d\0Edge\0Edge Pulse\0");
